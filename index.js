...
// var role = member.guild.roles.find("name", "BURGERS")
...
// channel.send(`Welkom bij de server Noord-Holland, Hopelijk heb je een leuke tijd ${member}`);
...
// var swearWords = ["fuck","fack","mongol","mogol","dikke","pattat"]
